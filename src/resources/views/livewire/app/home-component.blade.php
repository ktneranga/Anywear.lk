                            ...
                            <div class="product-grids clearfix">
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="shop.html"><img loading=lazy src="{{ asset('assets/images/feature-product/img-4.jpg') }}" alt></a>
                                    </div>
                                    <div class="details">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="shop.html"><img loading=lazy src="{{ asset('assets/images/feature-product/img-11.jpg') }}" alt></a>
                                    </div>
                                    <div class="details">
                                ...
                                <div class="grid">
                                    <div class="img-holder">
                                        <a href="shop.html"><img loading=lazy src="{{ asset('assets/images/feature-product/img-7.jpg') }}" alt></a>
                                    </div>
                                    <div class="details">
                                        <h3>Wool sweater</h3>
                                        <a href="shop.html" class="shop-btn">Shop Now</a>
                                ...
                                <ul class="products product-row-slider">
                                    <li class="product">
                                        <div class="product-holder">
                                            ...
                                            <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-1.jpg" alt></a>
                                        ...
                                        <div class="quick-view-single-product">
                                            <div class="view-single-product-inner clearfix">
                                                ...
                                                <div class="img-holder">
                                                    <img loading=lazy src="assets/images/shop/img-1.jpg" alt>
                                                </div>
                                    ...
                                    <li class="product">
                                        <div class="product-holder">
                                            <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-2.jpg" alt></a>
                                            <div class="shop-action-wrap">
                                                <ul class="shop-action">
                                                    <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                                    </li>
                                        ...
                                        <div class="quick-view-single-product">
                                            <div class="view-single-product-inner clearfix">
                                                <button class="btn quick-view-single-product-close-btn"><i
                                                        class="pe-7s-close-circle"></i></button>
                                                <div class="img-holder">
                                                    <img loading=lazy src="assets/images/shop/img-2.jpg" alt>
                                                </div>
                                                <div class="product-details">
                                    ...
                                    <li class="product">
                                        <div class="product-holder">
                                            <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-3.jpg" alt></a>
                                            <div class="shop-action-wrap">
                                                <ul class="shop-action">
                                                    <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                                    </li>
                                        ...
                                        <div class="quick-view-single-product">
                                            <div class="view-single-product-inner clearfix">
                                                <button class="btn quick-view-single-product-close-btn"><i
                                                        class="pe-7s-close-circle"></i></button>
                                                <div class="img-holder">
                                                    <img loading=lazy src="assets/images/shop/img-3.jpg" alt>
                                                </div>
                                                <div class="product-details">
                                                    <h4>Short Sleeve</h4>
                                                    <div class="price">
                                    ...
                                    <li class="product">
                                        <div class="product-holder">
                                            <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-4.jpg" alt></a>
                                            <div class="shop-action-wrap">
                                                <ul class="shop-action">
                                                    <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                                    </li>
                                        ...
                                        <div class="quick-view-single-product">
                                            <div class="view-single-product-inner clearfix">
                                                <button class="btn quick-view-single-product-close-btn"><i
                                                        class="pe-7s-close-circle"></i></button>
                                                <div class="img-holder">
                                                    <img loading=lazy src="assets/images/shop/img-4.jpg" alt>
                                                </div>
                                                <div class="product-details">
                                                    <h4>Stylish coat</h4>
                                                    <div class="price">
                                    ...
                                    <li class="product">
                                        <div class="product-holder">
                                            <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-5.jpg" alt></a>
                                            <div class="shop-action-wrap">
                                                <ul class="shop-action">
                                                    <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                                    </li>
                                        ...
                                        <div class="quick-view-single-product">
                                            <div class="view-single-product-inner clearfix">
                                                <button class="btn quick-view-single-product-close-btn"><i
                                                        class="pe-7s-close-circle"></i></button>
                                                <div class="img-holder">
                                                    <img loading=lazy src="assets/images/shop/img-5.jpg" alt>
                                                </div>
                                                <div class="product-details">
                                    ...
                                    <li class="product">
                                        <div class="product-holder">
                                            <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-6.jpg" alt></a>
                                            <div class="shop-action-wrap">
                                                <ul class="shop-action">
                                                    <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                                    </li>
                                        ...
                                        <div class="quick-view-single-product">
                                            <div class="view-single-product-inner clearfix">
                                                <button class="btn quick-view-single-product-close-btn"><i
                                                        class="pe-7s-close-circle"></i></button>
                                                <div class="img-holder">
                                                    <img loading=lazy src="assets/images/shop/img-6.jpg" alt>
                                                </div>
                                                <div class="product-details">
                                                    <h4>Two Colure Hoodie</h4>
                                                    <div class="price">
                    ...
                    <div class="row">
                        <div class="col col-xs-12">
                            <div class="section-title-s3">
                                <h2>فئات Azedw</h2>
                                <p>حملاتنا ، أحدث الاتجاهات والمجموعات الجديدة</p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col col-xs-12">
                    <div class="content-area">
                        ...
                        <a href="shop.html" class="theme-btn-s2">تسوق الآن</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="products-wrapper">
                        <ul class="products product-row-slider">
                            <li class="product">
                                <div class="product-holder">
                                    <div class="product-badge discount">-27%</div>
                                    <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-7.jpg" alt></a>
                                    <div class="shop-action-wrap">
                                        <ul class="shop-action">
                                            <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                            </li>
                                ...
                                <div class="quick-view-single-product">
                                    <div class="view-single-product-inner clearfix">
                                        <button class="btn quick-view-single-product-close-btn"><i
                                                class="pe-7s-close-circle"></i></button>
                                        <div class="img-holder">
                                            <img loading=lazy src="assets/images/shop/img-7.jpg" alt>
                                        </div>
                                        <div class="product-details">
                            ...
                            <li class="product">
                                <div class="product-holder">
                                    <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-8.jpg" alt></a>
                                    <div class="shop-action-wrap">
                                        <ul class="shop-action">
                                            <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                            </li>
                                ...
                                <div class="quick-view-single-product">
                                    <div class="view-single-product-inner clearfix">
                                        <button class="btn quick-view-single-product-close-btn"><i
                                                class="pe-7s-close-circle"></i></button>
                                        <div class="img-holder">
                                            <img loading=lazy src="assets/images/shop/img-8.jpg" alt>
                                        </div>
                                        <div class="product-details">
                            ...
                            <li class="product">
                                <div class="product-holder">
                                    <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-9.jpg" alt></a>
                                    <div class="shop-action-wrap">
                                        <ul class="shop-action">
                                            <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                            </li>
                                ...
                                <div class="quick-view-single-product">
                                    <div class="view-single-product-inner clearfix">
                                        <button class="btn quick-view-single-product-close-btn"><i
                                                class="pe-7s-close-circle"></i></button>
                                        <div class="img-holder">
                                            <img loading=lazy src="assets/images/shop/img-9.jpg" alt>
                                        </div>
                                        <div class="product-details">
                            ...
                            <li class="product">
                                <div class="product-holder">
                                    <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-10.jpg" alt></a>
                                    <div class="shop-action-wrap">
                                        <ul class="shop-action">
                                            <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                            </li>
                                ...
                                <div class="quick-view-single-product">
                                    <div class="view-single-product-inner clearfix">
                                        <button class="btn quick-view-single-product-close-btn"><i
                                                class="pe-7s-close-circle"></i></button>
                                        <div class="img-holder">
                                            <img loading=lazy src="assets/images/shop/img-10.jpg" alt>
                                        </div>
                                        <div class="product-details">
                                            <h4>Elegant tops</h4>
                                            <div class="price">
                            ...
                            <li class="product">
                                <div class="product-holder">
                                    <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-11.jpg" alt></a>
                                    <div class="shop-action-wrap">
                                        <ul class="shop-action">
                                            <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                            </li>
                                ...
                                <div class="quick-view-single-product">
                                    <div class="view-single-product-inner clearfix">
                                        <button class="btn quick-view-single-product-close-btn"><i
                                                class="pe-7s-close-circle"></i></button>
                                        <div class="img-holder">
                                            <img loading=lazy src="assets/images/shop/img-11.jpg" alt>
                                        </div>
                                        <div class="product-details">
                                            <h4>Two Colure Hoodie</h4>
                                            <div class="price">
                            ...
                            <li class="product">
                                <div class="product-holder">
                                    <a href="shop-single.html"><img loading=lazy src="assets/images/shop/img-12.jpg" alt></a>
                                    <div class="shop-action-wrap">
                                        <ul class="shop-action">
                                            <li><a href="#" title="Quick view!"><i class="fi flaticon-view"></i></a>
                                            </li>
                                ...
                                <div class="quick-view-single-product">
                                    <div class="view-single-product-inner clearfix">
                                        <button class="btn quick-view-single-product-close-btn"><i
                                                class="pe-7s-close-circle"></i></button>
                                        <div class="img-holder">
                                            <img loading=lazy src="assets/images/shop/img-12.jpg" alt>
                                        </div>
                                        <div class="product-details">
                                            <h4>Two Colure Hoodie</h4>
                                            <div class="price">
